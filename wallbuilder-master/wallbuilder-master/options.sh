...
fwbuilder_output_dir="$fwbuilder_base_dir/output"
fwbuilder_script_dir="$fwbuilder_base_dir/tuit-barracuda-scripts"
fwbuilder_config_file="$fwbuilder_base_dir/aixboms2cp.yaml"
...
fwbuilder_mailing_template_dir="$fwbuilder_base_dir/mailing"
